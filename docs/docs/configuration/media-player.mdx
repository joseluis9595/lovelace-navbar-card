...
| `desktop_position`       | `top-left` \| `top-center` \| `top-right` \| `bottom-left` \| `bottom-center` \| `bottom-right` | `bottom-center` | Position of the media player widget on desktop; also used by automatic padding to reserve space |
| `icon`                   | string \| [JSTemplate](../types/js-template)                   | `mdi:music` (or album cover if available)                | Icon to display in the media player. If configured, overrides the album cover image.           |
| `title`                   | string \| [JSTemplate](../types/js-template)                   | `media_title` attribute from entity                      | Title text displayed in the media player. Defaults to the media player's `media_title` attribute. |
| `subtitle`                | string \| [JSTemplate](../types/js-template)                   | `media_artist` attribute from entity                     | Subtitle text displayed in the media player. Defaults to the media player's `media_artist` attribute. |
